    ...
    <div class="container">
        ...
        <form action="" method="POST">
            <div class="form-group">
                <label for="pseudoconex">Nouveau mot de passe</label>
                <input required type="password" id="pseudoconex" name="password" class="form-control"/>
            </div>

            <div class="form-group">
                <label for="motdepasseconnx">Confirmation de mot de passe</label>
                <input required type="password" id="motdepasseconnx" name="password_confirm" class="form-control"/>
            </div>
