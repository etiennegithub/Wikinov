...
if(!empty($_POST) && !empty($_POST['username']) && !empty($_POST['password'])){
    ...
    if(password_verify($_POST['password'], $user->password)){
        ...
        header('Location: ./pages/firstlog.php ');
        exit();
    }else{
...
<![endif]-->
    ...
    <body>
            ...
            <form action="" method="POST">
                ...
                <div class="container">
                    <div class="form-group">
                        ...
                        <input id="pseudo_label" type="text" name="username" class="form-control" value="<?= (!empty($pseudo))?$pseudo:'' ?>" required/>
                    </div>

                    <div class="form-group">
                        <label for="motdepasse_label">Mot de passe <a href="pages/forget.php">(Mot de passe oublié)</a></label>
                        <input id="motdepasse_label" type="password" name="password" class="form-control" required/>
                    </div>
        ...
        <!--
        include, et securisation de la faille include
        -->
